...
//--METODOS DE CLASE
	...
	public static function TraerTodosLosProductosBD()
	{
        ...
        $consulta = $objetoAccesoDato->RetornarConsulta("SELECT *, codigo_barra AS codBarra,path_foto AS pathFoto  "
                                                        . "from producto");
        

      //  $consulta->execute(array("codigo_barra" => $codBarra, "nombre" => $nombre,"path_foto" =>$pathFoto));
		 $consulta->execute();
